...
1. **GitHub Private Vulnerability Reporting (Preferred)**: Navigate to the [Security Tab](https://github.com/SteveShi/PlistEditor/security) of this repository and click **"Report a vulnerability"**.
...
- **Entity Expansion Protection**: XML property list parsing enforces strict depth and expansion limits to mitigate XML Entity Expansion (Billion Laughs) attacks.
- **Binary Plist Bounds**: Binary plist offsets and object tables are strictly validated before deserialization.
