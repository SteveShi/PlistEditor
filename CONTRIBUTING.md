# Contributing to PlistEditor

Thank you for your interest in contributing to **PlistEditor**! PlistEditor is a modern, native macOS Property List editor built with SwiftUI.
...
1. Fork the repository and clone your fork locally:
   ```bash
   git clone https://github.com/<your-username>/PlistEditor.git
   cd PlistEditor
   ```
...
4. **Verification & Testing**:
   - Verify that the project compiles cleanly without warnings:
     ```bash
     xcodegen generate && xcodebuild -scheme PlistEditor -destination 'platform=macOS' build
     ```
...
By contributing to PlistEditor, you agree that your contributions will be licensed under the [Mozilla Public License Version 2.0](LICENSE).
